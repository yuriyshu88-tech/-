...
export function LoginScreen() {
  ...
  const handleLogin = () => {
    ...
    doLogin(account.trim(), password);
  };

  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Pressable hitSlop={12} onPress={() => setRoute('main')}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>登录后数据将同步到云端</Text>
      ...
      <View style={styles.bottomArea}>
        ...
        <Pressable style={styles.switchBtn} onPress={() => setRoute('register')}>
